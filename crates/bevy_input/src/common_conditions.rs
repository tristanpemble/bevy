...
///         .add_systems(Update, pause_menu.when(input_toggle_active(false, KeyCode::Escape)))
///         .run();
/// }
///
/// fn pause_menu() {
...
///         .add_systems(Update, pause_menu.when(|paused: Res<Paused>| paused.0))
///         .run();
/// }
///
...
///     App::new()
///         .add_plugins(DefaultPlugins)
///         .add_systems(Update, jump.when(input_just_pressed(KeyCode::Space)))
///         .run();
/// }
///
/// # fn jump() {}
